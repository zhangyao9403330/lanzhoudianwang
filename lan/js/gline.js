...
jiekoudizhi1 = 'http://172.16.15.130:9096/admin/line/lineListPOST?line_level=1'
jiekoudizhi2= 'http://172.16.15.130:9096/admin/line/lineListPOST?line_level=2'
jiekoudizhi3= 'http://172.16.15.130:9096/admin/line/lineListPOST?line_level=3'
jiekoudizhi4= 'http://172.16.15.130:9096/admin/line/lineListPOST?line_level=4'
jiekoudizhi5= 'http://172.16.15.130:9096/admin/line/lineListPOST?line_level=5'
// wurenji="http://172.16.15.46:8080/planeInfo" 
$(function () {
    yjxlgk(this.jiekoudizhi1,"#xl1")  //一级线路概况
    yjxlgk(this.jiekoudizhi2,"#xl2")  //一级线路概况
    yjxlgk(this.jiekoudizhi3,"#xl3")  //一级线路概况
    yjxlgk(this.jiekoudizhi4,"#xl4")  //一级线路概况
    yjxlgk(this.jiekoudizhi5,"#xl5")  //一级线路概况
    xldjfbt() //线路等级分布图
    voltage();
    bteam(); //班组线路分布图
})

function yjxlgk(url,dom) {
    $.ajax({
        url: url,
        type: "get",
        success: function (item) {
            ...
            shuju.map(function(item,index){
                ...
                html+='<ul><li>'+index+'</li><li>'+item.LINENAME+'</li><li>'+item.LINE_NO+'</li><li>'+item.USERNAME+'</li><li>'+item.DEPNAME+'</li> <li>'+item.JISHU+'</li><li>'+item.LINE_LENGTH+'</li> </ul>' 
            })
            $(dom).html(html)
        }
    })
